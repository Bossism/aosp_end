...
public class Counselor {
	...
	public void checkForRelatives(UMLClass umlClass, TypeDeclaration type){
		com.github.javaparser.ast.body.ClassOrInterfaceDeclaration classOrInterfaceDeclaration = (ClassOrInterfaceDeclaration) type;
		if(classOrInterfaceDeclaration.getExtends() != null){
			List<com.github.javaparser.ast.type.ClassOrInterfaceType> extendList = classOrInterfaceDeclaration.getExtends();
			for(com.github.javaparser.ast.type.ClassOrInterfaceType ext : extendList){
		...
		if(classOrInterfaceDeclaration.getImplements() != null){
			List<com.github.javaparser.ast.type.ClassOrInterfaceType> implementList = classOrInterfaceDeclaration.getImplements();
